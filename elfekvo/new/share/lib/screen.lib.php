	...
	if ($_SESSION[$config["configShare"]["whichSystemAndMode"] . "status_UserLevel"] != 1) {
		...
		'<form id="loginForm" method="post" action="">
			<div id="itemTitle" style="">
				<label title="'.$config["configShare"]["loginNicknameLabelTitle"].'">'.$config["configShare"]["loginNicknameLabelTitle"].'</label>
				<input type="text" name="x_nickname" id="x_nickname" value="" />
			</div>
			<div id="itemTitle" style="float:left;margin-right:5px;">
				<label title="'.$config["configShare"]["loginPasswordLabelTitle"].'">'.
				'<span class="glyphicons glyphicons-keys"></span>'.
				$config["configShare"]["loginPasswordLabelTitle"].'</label>
				<input type="password" name="x_password" id="x_password" value="" />
			</div>
			<div style="float:left;"></div>
				<button title="'.$config["configShare"]["loginSubmitButtonTextTitle"].'" id="buttonTopHeight24" name="modulOperation" type="submit" value="login"<span class="glyphicon glyphicon-log-in"></span></button>
			</div>
...
function subMenu($config, $p_itemValues, $p_modulMenu)
	...
	if (isModulView($config,$config["modulSelect"])) 
		...
		if (!isset($config[$config["modulSelect"]]["noView"]) || !$config[$config["modulSelect"]]["noView"])
			...
			if (($p_itemValues["x_id"] != NULL))
				{
				$subMenuHTML .= "<button class='buttonBox24x24' title='".$config["configShare"]["viewTitle"]."' id='' name='modulOperation' type='submit' value='item::view::".$config["modulSelect"]."::".urlencode($p_itemValues["x_id"])."'>
	...
	if (isModulAdd($config,$config["modulSelect"]) && setConfigValue($config,"configShare","onlyView") != 1  &&
		...
		if (!isset($config[$config["modulSelect"]]["noCopy"]) || !$config[$config["modulSelect"]]["noCopy"])
			...
			if (($p_itemValues["x_id"] != NULL))
				{
				$subMenuHTML .= "<button title='".$config["configShare"]["copyTitle"]."' class='buttonBox24x24' id='' name='modulOperation' type='submit' value='item::add::".$config["modulSelect"]."::".urlencode($p_itemValues["x_id"])."'>
		...
		if (!isset($config[$config["modulSelect"]]["noEdit"]) || !$config[$config["modulSelect"]]["noEdit"])
			...
			if (($p_itemValues["x_id"] != NULL))
				...
				if ($_SESSION[$config["configShare"]["whichSystemAndMode"]."status_UserLevel"] == 2 ||
					...
					{
					$subMenuHTML .= "<button title='".$config["configShare"]["editTitle"]."' class='buttonBox24x24' id='' name='modulOperation' type='submit' value='item::edit::".$config["modulSelect"]."::".urlencode($p_itemValues["x_id"])."'>
		...
		if (!isset($config[$config["modulSelect"]]["noDelete"]) || !$config[$config["modulSelect"]]["noDelete"])
			...
			if (($p_itemValues["x_id"] != NULL))
				...
				if ($_SESSION[$config["configShare"]["whichSystemAndMode"]."status_UserLevel"] == 2 ||
					...
					$config[$config["modulSelect"]]["resultRow"]["insertUserID"] == $_SESSION[$config["configShare"]["whichSystemAndMode"] . "status_UserID"])
					{
					$subMenuHTML .= "<button title='".$config["configShare"]["deleteTitle"]."' class='buttonBox24x24' id='' name='modulOperation' type='submit' value='item::delete::".$config["modulSelect"]."::".urlencode($p_itemValues["x_id"])."'>
	...
	if ($config[$config["modulSelect"]]["totalRecs"] > 0)
		...
		if ($config[$config["modulSelect"]]["listScroll"]!=1)
			...
			if ($config[$config["modulSelect"]]["startRec"] == 1)
				...
				{
		  		$config["sharedNavigation"] .= "<button class='buttonBox24x24' id='' title='".$config["configShare"]["firstTitle"]."' name='modulOperation' type='submit' value='start::".$config["modulSelect"]."::1'><span data-caption='Active' class='glyphicon glyphicon-fast-backward ewIcon' data-phrase='DeleteLink'></span></button>";
				}
			}
		...
		if ($config[$config["modulSelect"]]["listScroll"]!=1)
			...
			if ($config[$config["modulSelect"]]["PrevStart"] == $config[$config["modulSelect"]]["startRec"])
				...
				{
		  		$config["sharedNavigation"] .= "<button class='buttonBox24x24' id='' title='".$config["configShare"]["prevTitle"]."' name='modulOperation' type='submit' value='start::".$config["modulSelect"]."::".$config[$config["modulSelect"]]["PrevStart"]."'><span data-caption='Active' class='glyphicon glyphicon-backward ewIcon' data-phrase='DeleteLink'></span></button>";
				}
			if ($config[$config["modulSelect"]]["startRec"]!=1)
				{
		  		$config["sharedNavigation"] .= "<button class='buttonBox24x24' id='' title='".$config["configShare"]["prevItemTitle"]."' name='modulOperation' type='submit' value='start::".$config["modulSelect"]."::".($config[$config["modulSelect"]]["startRec"]-1)."'><span data-caption='Active' class='glyphicon glyphicon-step-backward ewIcon' data-phrase='DeleteLink'></span></button>";
				}
			else
				{
				$config["sharedNavigation"] .= "<img src='" . $config["configShare"]["imageButton"] . setConfigValue($config,$config["modulSelect"],"noButton")."' border='0' class='buttonBox'>";
		...
		if ($config[$config["modulSelect"]]["listScroll"]!=1)
			...
			if ($config[$config["modulSelect"]]["startRec"]<$config[$config["modulSelect"]]["totalRecs"]-$config[$config["modulSelect"]]["displayRecs"]+1)
				{
		  		$config["sharedNavigation"] .= "<button class='buttonBox24x24' id='' title='".setConfigValue($config,$config["modulSelect"],"nextItemTitle")."' name='modulOperation' type='submit' value='start::".$config["modulSelect"]."::".($config[$config["modulSelect"]]["startRec"]+1)."'><span data-caption='Active' class='glyphicon glyphicon-step-forward ewIcon' data-phrase='DeleteLink'></span></button>";
				}
			else
				{
				$config["sharedNavigation"] .= "<img src='" . $config["configShare"]["imageButton"] . setConfigValue($config,$config["modulSelect"],"noButton")."' border='0' class='buttonBox'>";
			...
			if ($config[$config["modulSelect"]]["NextStart"] == $config[$config["modulSelect"]]["startRec"])
				...
				{
		  		$config["sharedNavigation"] .= "<button class='buttonBox24x24' id='' title='".setConfigValue($config,$config["modulSelect"],"nextTitle")."' name='modulOperation' type='submit' value='start::".$config["modulSelect"]."::".$config[$config["modulSelect"]]["NextStart"]."'><span data-caption='Active' class='glyphicon glyphicon-forward ewIcon' data-phrase='DeleteLink'></button>";
				}
			}
		// last page button 
		if ($config[$config["modulSelect"]]["listScroll"]!=1)
			...
			if ($config[$config["modulSelect"]]["startRec"]<$config[$config["modulSelect"]]["totalRecs"]-$config[$config["modulSelect"]]["displayRecs"]+1)
				{
		  		$config["sharedNavigation"] .= "<button class='buttonBox24x24' id='' title='".setConfigValue($config,$config["modulSelect"],"lastTitle")."' name='modulOperation' type='submit' value='start::".$config["modulSelect"]."::".$config[$config["modulSelect"]]["LastStart"]."'><span data-caption='Active' class='glyphicon glyphicon-fast-forward ewIcon' data-phrase='DeleteLink'></button>";
				}
			else
				{
				$config["sharedNavigation"] .= "<img src='" . $config["configShare"]["imageButton"] . setConfigValue($config,$config["modulSelect"],"noButton")."' border='0' class='buttonBox'>";
		...
		if (isModulAdd($config,$config["modulSelect"]))
			...
			if ((!isset($config[$config["modulSelect"]]["noAdd"]) || !$config[$config["modulSelect"]]["noAdd"]) && (!isset($GLOBALS["treeAdmin"]) || !$GLOBALS["treeAdmin"]))
				{
				$config["sharedNavigationAdd"] .= "<button title='".$config["configShare"]["addTitle"]."' class='buttonBox24x24' name='modulOperation' type='submit' value='item::add::".$config["modulSelect"]."::'><span data-caption='Active' class='glyphicon glyphicon-plus ewIcon' data-phrase='DeleteLink'></span></button>";
				}
			}
		else
			{
		...
		for ($navigationAddItemCFGCount=0;$navigationAddItemCFGCount<count($navigationAddItemsCFG);$navigationAddItemCFGCount++) {
			...
			if (!empty($navigationAddItemCFG[0])) {
				if ($navigationAddItemCFG[0]=="import") {
					if ($_SESSION[$config["configShare"]["whichSystemAndMode"]."status_UserLevel"] != 1) {
						$config["sharedNavigationAdd"] .= "<button title='".$config[$config["modulSelect"]][	$navigationAddItemCFG[1]."Title"]."' class='buttonBox24x24' name='modulOperation' type='submit' value='item::".$navigationAddItemCFG[1]."::".$config["modulSelect"]."'>".$navigationAddItemCFG[1]."</button>";
					}
				} else if ($navigationAddItemCFG[0]=="export") {
					if ($_SESSION[$config["configShare"]["whichSystemAndMode"]."status_UserLevel"] != 1) {
						$config["sharedNavigationAdd"] .= "<button title='".$config[$config["modulSelect"]][$navigationAddItemCFG[1]."Title"]."' class='buttonBox24x24' name='modulOperation' type='submit' value='item::".$navigationAddItemCFG[1]."::".$config["modulSelect"]."'><span data-caption='Active' class='glyphicon glyphicon-arrow-down' data-phrase='ExportLink'></span></button>";
					}
				} else if ($navigationAddItemCFG[0]!="pdf") {
					$config["sharedNavigationAdd"] .= "<button title='".$config[$config["modulSelect"]][$navigationAddItemCFG[1]."Title"]."' class='buttonBox24x24' name='modulOperation' type='submit' value='item::".$navigationAddItemCFG[1]."::".$config["modulSelect"]."'><span data-caption='Active' class='glyphicon glyphicon-plus ewIcon' data-phrase='DeleteLink'></span></button>";
				}
			}
		}
		if ($config[$config["modulSelect"]]["navigationNoText"]==1)
		...
		for ($navigationAddItemCFGCount=0;$navigationAddItemCFGCount<count($navigationAddItemsCFG);$navigationAddItemCFGCount++)
			...
			if (!empty($navigationAddItemCFG[0]))
				...
				if ($navigationAddItemCFG[0]=="import") {
					if ($_SESSION[$config["configShare"]["whichSystemAndMode"]."status_UserLevel"] != 1) {
						$config["sharedNavigationAdd"] .= "<button title='".$config[$config["modulSelect"]][$navigationAddItemCFG[1]."Title"]."' class='buttonBox24x24' name='modulOperation' type='submit' value='item::".$navigationAddItemCFG[1]."::".$config["modulSelect"]."'>".$config["modulSelect"]."</button>";
					}
				} else if ($navigationAddItemCFG[0]=="export") {
					if ($_SESSION[$config["configShare"]["whichSystemAndMode"]."status_UserLevel"] != 1) {
						$config["sharedNavigationAdd"] .= "<button title='".$config[$config["modulSelect"]][$navigationAddItemCFG[1]."Title"]."' class='buttonBox24x24' name='modulOperation' type='submit' value='item::".$navigationAddItemCFG[1]."::".$config["modulSelect"]."'><span data-caption='Active' class='glyphicon glyphicon-arrow-down' data-phrase='ExportLink'></span></button>";
